...
CREATE TABLE IF NOT EXISTS `agentname` (
  `name_id` int(11) NOT NULL AUTOINCREMENT,
  ...
  PRIMARY KEY (`name_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTOINCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `announced_lga_results` (
  `result_id` int(11) NOT NULL AUTOINCREMENT,
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTOINCREMENT=244 ;
...
CREATE TABLE IF NOT EXISTS `announced_pu_results` (
  ...
  `user_ip_address` varchar(50) NOT NULL,
  PRIMARY KEY (`result_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTOINCREMENT=261 ;
...
CREATE TABLE IF NOT EXISTS `announced_state_results` (
  ...
  `user_ip_address` varchar(50) NOT NULL,
  PRIMARY KEY (`result_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTOINCREMENT=1 ;
